...
namespace Javsdt.Data.Migrations
{
    ...
    [Migration("20240519142558_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarGenres", b =>
                {
            ...
            modelBuilder.Entity("Javsdt.Shared.Entitys.Media.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Javsdt.Shared.Entitys.Media.Publisher", b =>
                {
                    b.Property<string>("Name")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CarGenres", b =>
                {
                    b.HasOne("Javsdt.Shared.Entitys.Media.Car", null)
                        .WithMany()
                        .HasForeignKey("CarsName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Javsdt.Shared.Entitys.Media.Genre", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Javsdt.Shared.Entitys.Media.Car", b =>
                {
                    ...
                    b.HasOne("Javsdt.Shared.Entitys.Media.Publisher", null)
                        .WithMany("Cars")
